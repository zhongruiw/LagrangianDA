...
da_pos = np.load('../data/LSMDA_pos_K128_beta22_tr_L64.npz')
...
# Lagrangian DA
N = 1000 #psi1_k_t_fine.shape[-1]
N_chunk = 1000
N_s = 128 # number of sample trajectories

# minimize RAM usage
sel0 = 357*500
psi2_k_t = psi2_k_t[:,:,sel0//s_rate]
mu_t_lsm = mu_t_lsm[:,sel0:sel0+N]
R_t_lsm = R_t_lsm[:,sel0:sel0+N]
del da_pos
...
np.savez('../data/CGDA_ens128_pos_K128_beta22_tr_L64_2.npz', **da_pos)