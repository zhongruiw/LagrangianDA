...
da_pos = np.load('../data/LSMDA_pos_K128_beta111_tr_L64.npz')
...
# load data
data = np.load('../data/Sigma_cali_CGDA_K128_beta111_tr.npz')
Sigma1 = data['Sigma1']
Sigma2 = data['Sigma2']
...
np.savez('../data/CGDA_ens16_pos_K128_beta111_tr_L64.npz', **da_pos)