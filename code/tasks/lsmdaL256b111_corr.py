...
r1 = eigens['r1']
r2 = eigens['r2']
est_params = np.load('../data/est_paras_ou_K128_beta111_tr.npz')
gamma_est = est_params['gamma']
omega_est = est_params['omega']
f_est = est_params['f']
sigma_est = est_params['sigma']
est_params = np.load('../data/est_paras_cn_ou_K128_beta111_tr.npz')
...
#     'L': L
# }
# np.savez('../data/LSMDA_pos_K128_beta22_tr_L64.npz', **da_pos)
...
np.savez('../data/LSMDA_cn_pos_K128_beta111_tr_L256.npz', **da_pos)