...
% kb = sqrt(377); % Nondimensional beta wavenumber, beta = kb^2 
...
if any(isnan(q(:)))
    ...
    save('QG_DATA_topo10_nu1e-12_beta377_K128_dt5e-4_subs.mat','ii','countDiag','dt','tol','params','T','ke','ape','ene','etp','vb','utz', 'qp','topo','psi_1_t','psi_2_t','s_rate','cut','psi_1_t_fine','-v7.3'); 
end
...
print(h5, 'upper_topo10_nu1e-12_beta377_K128_dt5e-4_linearqg_snap.png', '-dpng', '-r150') 
...
print(h6, 'lower_topo10_nu1e-12_beta377_K128_dt5e-4_linearqg_snap.png', '-dpng', '-r150') 
...
xlabel('x'); ylabel('y');
print(h, 'mode_topo10_nu1e-12_beta377_K128_dt5e-4_linearqg.png', '-dpng', '-r150') 
...
print(h1, 'energy_topo10_nu1e-12_beta377_K128_dt5e-4_linearqg.png', '-dpng', '-r150')
...
print(h3, 'mode_ene_ens_topo10_nu1e-12_beta377_K128_dt5e-4_linearqg.png', '-dpng', '-r150')
...
print(h4, 'series_ene_ens_topo10_nu1e-12_beta377_K128_dt5e-4_linearqg.png', '-dpng', '-r150')