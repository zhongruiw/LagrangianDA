...
dt = 1E-4;     % initial time step size
Nt = 30*1E4;      % Number of time steps
...
if any(isnan(q(:)))
    ...
    save('QG_DATA_topo10_nu1e-12_beta22_K128_dt1e-4_subs.mat','ii','countDiag','dt','tol','params','T','ke','ape','ene','etp','vb','utz', 'qp','topo','psi_1_t','psi_2_t','s_rate','cut','psi_1_t_fine','-v7.3'); 
end
...
print(h5, 'upper_topo10_nu1e-12_beta22_K128_dt1e-4_subs_snap.png', '-dpng', '-r150') 
...
print(h6, 'lower_topo10_nu1e-12_beta22_K128_dt1e-4_subs_snap.png', '-dpng', '-r150') 
...
xlabel('x'); ylabel('y');
print(h, 'mode_topo10_nu1e-12_beta22_K128_dt1e-4_subs.png', '-dpng', '-r150') 
...
print(h1, 'energy_topo10_nu1e-12_beta22_K128_dt1e-4_subs.png', '-dpng', '-r150')
...
print(h3, 'mode_ene_ens_topo10_nu1e-12_beta22_K128_dt1e-4_subs.png', '-dpng', '-r150')
...
print(h4, 'series_ene_ens_topo10_nu1e-12_beta22_K128_dt1e-4_subs.png', '-dpng', '-r150')